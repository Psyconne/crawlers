...
BASE_URL = 'http://forum.insidepro.com/'
connect = MySQLdb.connect(host='localhost', user='inside', passwd='inside', db='insidepro')
connect.set_character_set('utf8')
cur = connect.cursor()
cur.execute('SET NAMES utf8;')
cur.execute('SET CHARACTER SET utf8;')
cur.execute('SET character_set_connection=utf8;')
LOG_FILENAME = 'insidepro.log'
...
if __name__ == "__main__":
    check_and_save('http://forum.insidepro.com/viewtopic.php?t=39174')
